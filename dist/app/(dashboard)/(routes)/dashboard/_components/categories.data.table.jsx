...
exports.DataCategoriesTable = void 0;
...
function DataCategoriesTable(_a) {
    var _b, _c, _d;
    ...
    return (<div className="text-[#f5f5f5] my-5 border-2 p-4 border-[#f5f5f5] rounded-lg">
      <div className="flex items-center py-4 justify-between gap-x-2">
        <input_1.Input placeholder='Pesquisar categoria por "nome"' value={(_c = (_b = table.getColumn('name')) === null || _b === void 0 ? void 0 : _b.getFilterValue()) !== null && _c !== void 0 ? _c : ''} onChange={function (event) { var _a; return (_a = table.getColumn('name')) === null || _a === void 0 ? void 0 : _a.setFilterValue(event.target.value); }} className="max-w-sm w-full bg-transparent border-2 placeholder:text-[#f5f5f5] text-[#f5f5f5] border-[#f5f5f5]"/>
        <link_1.default href="/dashboard/add-category" passHref>
          <button_1.Button variant="outline" className="bg-transparent hover:bg-[#121214] hover:text-[#f5f5f5] transition-all duration-300 ease-in-out">
            Adicionar Categoria
          </button_1.Button>
        </link_1.default>
      </div>
...
exports.DataCategoriesTable = DataCategoriesTable;
