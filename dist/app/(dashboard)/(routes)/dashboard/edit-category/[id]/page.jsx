...
function EditCategory() {
    ...
    var _d = (0, react_1.useState)(null), currentImage = _d[0], setCurrentImage = _d[1];
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, axios_1.default.get("/api/categories/".concat(id))];
                        case 1:
                            data = (_a.sent()).data;
                            setName(data.name);
                        ...
                        case 2:
                            ...
                            react_hot_toast_1.default.error('Failed to load category');
                            return [3 /*break*/, 3];
    ...
    var handleSubmit = function (e) { return __awaiter(_this, void 0, void 0, function () {
        var imageUrl, response, blob, storageRef, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    e.preventDefault();
                ...
                case 1:
                    ...
                    if (!(image !== currentImage)) return [3 /*break*/, 6];
                ...
                case 5:
                    imageUrl = _a.sent();
                    _a.label = 6;
                case 6: return [4 /*yield*/, axios_1.default.patch("/api/categories/".concat(id), { name: name, image: imageUrl })];
                case 7:
                    _a.sent();
                    react_hot_toast_1.default.success('Category updated successfully!');
                    return [3 /*break*/, 10];
                case 8:
                    error_2 = _a.sent();
                    console.error(error_2);
                    react_hot_toast_1.default.error('Failed to update category');
                    return [3 /*break*/, 10];
                case 9:
                    setLoading(false);
                    return [7 /*endfinally*/];
    ...
    return (<div className="flex flex-col items-center justify-center min-h-screen py-2">
      ...
      <link_1.default href="/dashboard" className="text-[#f5f5f5] hover:text-white mb-4 text-sm">
        Voltar ao Dashboard
      </link_1.default>
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center">
            <label className="flex flex-col items-center px-4 py-6 bg-[#333333] text-[#f5f5f5] rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer hover:bg-[#222222] hover:text-white" htmlFor="image">
              ...
              <input type="file" id="image" accept="image/*" onChange={handleImage} className="hidden"/>
            </label>
            {image && (<image_1.default src={image} alt="Preview" className="ml-4 w-24 h-24 object-cover rounded-lg" width={100} height={100}/>)}
          </div>
        </div>
        <div className="flex items-center justify-between">
          <button type="submit" disabled={!name || !image} className={"".concat(!name || !image
            ? 'cursor-not-allowed bg-[#333333] text-[#f5f5f5]'
            : 'border-2 border-[#f5f5f5] hover:bg-[#333333] hover:border-[#f5f5f5] hover:text-white', " text-white flex justify-center items-center font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline")}>
            {loading ? (<ai_1.AiOutlineLoading3Quarters className="animate-spin"/>) : ('Salvar Alterações')}
          </button>
        </div>
      </form>
    </div>);
